...
<?php
	...
	// 검색과 default가 존재
	// 검색의 경우 mode를 get방식으로 넘겨 이를 받아내야함.
	// isset에서 mode의 값을 받아오는지 아는지 확인하여 설정.
	if(isset($_GET['mode'])){
		$mode=$_GET['mode'];
	}
	else{
	...
	try{
		...
		if ($mode=="search")
		{
			...
			// find는 찾고자 하는 select 항목. 제목, 내용, 별명, 이름
			$find = $_POST['find'];
			// search는 찾고자 하는 내용.
			$search = $_POST['search'];
			if(!$search)
...
<?php
	try{
      ...
      // $row = mysql_fetch_array($result); // 하나의 레코드 가져오기
		...
		// PDO::FETCH_ASSOC,PDO::FETCH_ORI_ABS
